                            ...
                            <div class="text-center">
                                ...
                                <small class="mt-4">{{ Auth::user()->description }}</small>
                                  <div class="social-buttons mt-5" >
                                   <button class="neo-button" data-toggle="tooltip" data-html="true" title="Profil szeresztése">
                                    <a href="{{ route('edit') }}">
                                   ...
                                   <button class="neo-button" data-toggle="tooltip" data-html="true" title="Saját jármű hozzáadása">
                                   ...
                                   <button class="neo-button" data-toggle="tooltip" data-html="true" title="Kilépés">
                                    <a href="{{ route('logout') }}">
